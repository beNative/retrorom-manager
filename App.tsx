    ...
    <ThemeProvider>
      <div className="flex flex-col h-screen bg-retro-900 text-gray-100 overflow-hidden font-sans transition-colors duration-200 dark:bg-retro-900 dark:text-gray-100 bg-gray-50 text-gray-900">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {/* Main Content */}
          <div className="flex-1 flex flex-col min-w-0 bg-retro-900 dark:bg-retro-900 bg-gray-50">
            {activeView === 'info' ? (
              <InfoTab />
            ) : activeView === 'settings' ? (
              <SettingsTab
              ...
              <>
                ...
                <div className="flex-1 overflow-auto p-4">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-full">
                    ...
                    <div className="lg:col-span-2 flex flex-col h-full min-h-0 border-r border-retro-700 pr-2 dark:border-retro-700 border-gray-200">
                      <GameTable
                    ...
                    <div className="lg:col-span-1 flex flex-col h-full min-h-0 pl-2 overflow-hidden">
                      <div className="p-2 text-xs font-bold uppercase tracking-wider flex items-center gap-2 text-gray-400 border-b border-retro-700 mb-2 flex-shrink-0 dark:border-retro-700 border-gray-200">
                        <Terminal size={14} /> Operation Logs
                      </div>
                      <div className="flex-1 overflow-auto font-mono text-xs text-green-400 space-y-1 dark:text-green-400 text-green-600">
                        {logs.length === 0 && <span className="text-gray-600">Ready...</span>}
                        {logs.map((log, i) => (
                          <div key={i} className="break-all border-b border-gray-800/50 pb-1 mb-1 last:border-0 dark:border-gray-800/50 border-gray-200">
                            {log}
                          </div>
                        ))}
                        <div id="log-end" />
